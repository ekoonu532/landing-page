...
const Navbar = () => {
    ...
    let scrollActive = scroll ? "py-6 bg-white" : "py-4";
        ...
        <div className={`navbar fixed w-full transition-all ${scrollActive}`}>
            <div className="container mx-auto px-4">
                <div className="navbar-box flex items-center justify-between">
                    <div className="logo">
                        <h1 className='sm:text-2xl text-xl font-bold'>Landingpage</h1>
                    </div>
                    ...
                    <div className="social flex items-center gap-2">
                        ...
                        <div
                            className={`hamburger md:hidden block ${isHamburgerActive ? "hamburger-active" : ""}`}
                            onClick={handleClick}>
                            <span className="hamburger-line w-[30px] h-[2px] my-2 block bg-black transition duration-300 ease-in-out origin-top-left"></span>
                            <span className="hamburger-line w-[30px] h-[2px] my-2 block bg-black transition duration-300 ease-in-out"></span>
                            <span className="hamburger-line w-[30px] h-[2px] my-2 block bg-black transition duration-300 ease-in-out origin-bottom-left"></span>
                        </div>
                    </div>
                </div>
            </div>
